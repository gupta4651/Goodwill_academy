    ...
    <footer className="bg-slate-950 pt-16 text-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid gap-10 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_1fr_1.2fr]">
          <div>
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-md bg-cyan-700">
                <span className="font-black text-white">GG</span>
              </div>
              <div>
                <h3 className="font-black">GOODWILL GATE ACADEMY</h3>
                <p className="text-xs font-bold text-cyan-200">Engineering + Computer Institute</p>
              </div>
            </div>
            <p className="max-w-sm leading-7 text-slate-400">
              Engineering-focused coaching for GATE, engineering subjects, polytechnic preparation, and computer certifications in Nagpur.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                <MapPin className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-300" />
        ...
        <div className="flex flex-col gap-3 border-t border-white/10 py-6 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          <p>&copy; {new Date().getFullYear()} Goodwill GATE Academy. All rights reserved.</p>
